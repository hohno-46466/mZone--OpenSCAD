...
// Raspberry Pi 3B+/4B
//
// RaspberryPi3B4B-2-20260103H.scad (RPi3B/4B-2-20260103H)
//
// https://www.raspberrypi.com/documentation/computers/raspberry-pi.html
//
// Prev update: 2025-05-16(Fri) 05:41 JST / 2025-05-15(Thu) 20:41 UTC
// Prev update: 2025-05-25(Sun) 08:08 JST / 2025-05-24(Sat) 23:08 UTC
// Last update: 2026-01-04(Sun) 02:29 JST / 2026-01-03(Sat) 17:29 UTC
//

Px = 85.0; Py = -56.0; Pz = 3.0;    // パネルの 横・縦・厚さ （P は "Panel" の P）
Cd = 6.0;  Cz = 3.0;                // 円柱の直径、厚さ （Cは "Cylinder" の C）
H1d = 3.0; H2d = 2.8;               // 穴1,穴2の直径 （H は "Hole" の H）

tdepth = 2.0;                       // 文字を掘る深さ（mm）
text = "RPi3B/4B-2-20260103H";
