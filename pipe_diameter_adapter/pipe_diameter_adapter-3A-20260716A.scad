//
// pipe_diameter_adapter-3A-20260716A.scad
// 

// Prev update: 2026-07-06(Mon) 13:18 JST / 2026-07-06(Mon) 04:18 UTC by @hohno_at_monkKB with ChatGPT
// Prev update: 2026-07-10(Fri) 10:03 JST / 2026-07-10(Fri) 01:03 UTC (introducing module)
// Prev update: 2026-07-13(Mon) 09:29 JST / 2026-07-13(Mon) 00:29 UTC
// Last update: 2026-07-16(Thu) 11:38 JST / 2026-07-16(Thu) 02:38 UTC

module pipe_diameter_adapter() {
    // Parameters
    outer_inner_diameter  = 146.0;
    outer_outer_diameter  = 152.0;
    outer_height          = 50.0; // 45.0;

    lid_thickness         = 3.0;

    center_inner_diameter = 65.0;
    center_outer_diameter = 70.0;
    center_height         = 70.0; // 65.0;

    window_width          = 20.0; // 15.0; // 12.5;
    window_depth          = 10.0;
    window_height         = 16.0; // 10.0;
    window_bottom         = 16.0; // 22.0;
    ...
    difference() {
        union() {
            ...
            translate([0, 0, outer_height - lid_thickness*1])
